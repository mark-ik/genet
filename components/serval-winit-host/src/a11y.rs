...
//! Platform AccessKit bridge for a serval-on-winit host.
//!
//! A host builds its accessibility tree however it likes (serval's
//! [`serval_layout::build_subtree`] projects a laid-out DOM; a host may stitch
