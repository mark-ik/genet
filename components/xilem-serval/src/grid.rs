...
//! The data grid (chisel catalog's flagship arrangement widget): a sticky
    ...
    Action: 'static,
{
    ...
    let header = el::<_, State, Action>("div", header_cells)
        ...
        .attr(
            "style",
            format!("position: relative; width: {width}px; height: {}px;", spec.header_height),
        );
...
mod tests {
    ...
    /// growing the DOM, and a chisel leaf rides as a cell view.
    #[test]
