...
pub use table::{
    ...
    FragmentDraft, FragmentDraftTree, GridEdgeOrientation, InlineSizeConstraint, TableAlignment,
    ...
    TableBorderCandidate, TableBorderCandidates, TableBorderError, TableBorderOrderKey,
    TableBorderOrigin, TableBorderSide, TableBorderSides, TableBorderSource, TableBorderStyle,
    ...
    collect_table_border_candidates, collect_table_cell_inline_measures, emit_table_fragments,
    format_table_cells, layout_table_block, measure_automatic_columns, measure_single_span_rows,
    query_table_cell_inline_sizes, resolve_percentage_block_sizes, size_automatic_table_inline,
