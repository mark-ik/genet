...
pub use table::{
    ...
    TableBoxSizing, TableCell, TableCellAlignment, TableCellBlockStyle, TableCellFormatter,
    TableCellInlineMeasure, TableCellInlineStyle, TableCellInput, TableCellLayoutInput,
    TableCellLayoutOutput, TableCellLayoutPass, TableCellPlacement, TableColumnMeasure,
