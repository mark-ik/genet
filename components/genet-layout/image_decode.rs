...
//! genet** — per the Hekate lanes doc, fetching is the host /
//! network-adapter's job; genet consumes bytes. The seam is an
...
/// genet itself doesn't fetch. The host (or Hekate's network
