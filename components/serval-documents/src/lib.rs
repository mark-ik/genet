...
/// Structural display defaults the lanes layer over serval's UA cascade, so a
...
/// follow-up. serval-scripted carries its own copy for the same reason.)
...
#[cfg(feature = "scripted")]
impl serval_scripted::ResourceFetcher for document::LocalFetcher {
