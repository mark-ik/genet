...
fn generate(db: &Database) -> String {
    ...
    for property in &db.property {
        ...
        out.push_str(&format!(
            "            Self::{variant} => PropertyMetadata {{ id: Self::{variant}, name: {name}, inherited: {inherited}, initial: {initial}, grammar: {grammar}, seed_values: {seed_values}, animation: {animation}, source_url: {source} }},\n",
