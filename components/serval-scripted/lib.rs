...
/// collector it feeds, in `serval-scripted-dom` as [`Pins`] (keyed on `NodeId`).
...
pub use serval_scripted_dom::Pins as ReflectorPins;
...
mod pin_tests {
    ...
    // The pure pin-set unit tests live with the type in serval-scripted-dom; this
