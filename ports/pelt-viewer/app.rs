...
//! The Xilem viewer app: a navigation bar above a serval-rendered
//! content image. "Go" re-renders synchronously (fine for static
//! content). Adapted from `wgpu-graft/demo-servo-xilem`.
