...
- Remaining I3 work: fuller spec reaction-stack semantics, `adoptedCallback`, construction failure states, fuller custom-element name validation, parser-created custom-element timing, and a measured WPT delta once the harness count is trustworthy.
