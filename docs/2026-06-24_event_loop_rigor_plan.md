...
**Date:** 2026-06-24
**Status:** E1 landed 2026-06-30. E2 landed + verified 2026-06-30. E3 event-loop/task-source surface landed 2026-06-30. E4 completed 2026-07-02: scheduler trace capture, the base scheduler witness, and the first real protocol witness (`postMessage`) all pass TLC, with a negative bad-trace check failing as intended. Additional protocol specs remain optional follow-on rigor. Spun out of the gterzian/formal-web harvest (`2026-06-24_formal_web_lessons.md`, ideas 3/4/7 + the two bug-rules) and the grand audit §6 ("the gaps are granularity, not architecture").
